...
function run {
    ...
    cp ./getty.override.conf "$root/etc/systemd/system/getty@tty1.service.d/override.conf"
    ...
    pacstrap -d "$root" base base-devel btrfs-progs sudo wget curl lshw mkinitcpio-nfs-utils nfs-utils bind-tools
